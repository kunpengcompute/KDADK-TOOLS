...
|--|--|
| Network flow classification| Provides the header files and software packages of the feature extraction and inference APIs and a reference example of network flow classification of Kunpeng BoostKit for IDA.|
...
└── README.md                                                 # Introduction to the KDADK-TOOLS project
```
...
For details about how to deploy and install the KDADK-TOOLS environment, see [Installation Guide](docs/en/installation_guide.md).
...
| -- | -- |
| [Release Notes](docs/en/release_notes.md)| Provides version updates of KDADK-TOOLS.|
...
| [User Guide](docs/en/user_guide.md)| Provides detailed usage of the KDADK-TOOLS demo and traffic collection and labeling tools.|
| [API Reference](docs/en/api_reference.md)| Provides the description of the KTAG feature extraction and inference APIs.|
| [FAQs](docs/en/faq.md)| Lists FAQs about KDADK-TOOLS.|

## Contribution Statement

If you have any questions or want to provide feedback on feature requirements and bug reports, you can submit issues. 
...
- This project provides only reference examples and tools. You are responsible for any risks and should carefully review the following information:
    - Data processing and deletion: Users are responsible for managing and deleting any data generated while using this tool. You are advised to delete such data promptly after use to prevent information leakage.
