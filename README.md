...
\[2026-03-30\]: 发布KDADK-TOOLS 1.1.0。更新了特征提取及特征推理接口头文件及软件包，提供了鲲鹏数据分析开发套件的网络流分类参考示例。
...
|特性名称|特性介绍
|--|--|
| 加密流量处理 | 加密流量处理特性提供了特征提取、特征推理接口头文件及软件包，同时提供了鲲鹏数据分析开发套件的网络流分类参考示例。 |
...
## 快速上手
KDADK-TOOLS的快速入门通过使用kdadk_demo来实现，具体请参见《[快速入门](docs/zh/quick_start.md#快速入门)》。
...
| 《[版本说明书](docs/zh/release_notes.md#版本说明书)》 | 提供了版本更新说明。 |
| 《[安装指南](docs/zh/installation_guide.md#安装指南)》 | 提供了demo示例的依赖包安装及编译方法。 |
| 《[用户指南](docs/zh/user_guide.md#用户指南)》 | 提供了demo示例、流量采集工具及流量打标签工具的详细用法。 |
| 《[API参考](docs/zh/api_reference.md#api参考)》 | 提供了特征提取和特征推理的接口说明。 |
| 《[常见问题](docs/zh/faq.md#常见问题)》 | 列举了常见的一些问题。 |
