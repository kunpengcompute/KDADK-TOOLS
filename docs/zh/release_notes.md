...
|发布日期|修改说明|
|--|--|
|2026-06-30|KDADK-APPID更名为KTAG，功能未变更。|
|2026-03-30|第一次正式发布。更新了KDADK-APPID网络流量分类库的特征提取及特征推理接口头文件及软件包，提供了鲲鹏BoostKit智能数据分析开发套件的网络流分类参考示例。|
...
|特性名称| 更新说明                                     |
|--|------------------------------------------|
|网络流量分类| 更新了特征提取及特征推理接口头文件及软件包，提供了鲲鹏BoostKit智能数据分析开发套件的网络流分类参考示例。  |
